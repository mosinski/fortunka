class FortunesController < ApplicationController
  ...
  # GET /fortunes.json
  def index
    @fortunes = Fortune.order(sort_column + " " + sort_direction).page(params[:page]).per_page(4).search(params[:search], params[:page])
  ...
  def sort_column
    Fortune.column_names.include?(params[:sort]) ? params[:sort] : "cytat"
  end
